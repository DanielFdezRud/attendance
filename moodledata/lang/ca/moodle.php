...
/**
 * Strings for component 'moodle', language 'ca', version '3.9'.
 *
 * @package     moodle
 * @category    string
...
$string['uf'] = 'Categoria del curs';
$string['uf_help'] = 'Aquest paràmetre determina en quina uf, dins la llista de moduls.';
$string['ufdeleted'] = 'S\'ha suprimit la uf de modul {$a}';
